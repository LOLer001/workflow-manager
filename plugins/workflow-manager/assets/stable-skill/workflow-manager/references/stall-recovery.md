...
Native nonempty bounded result and review prose are sufficient when the separately bound host evidence is current. Result formatting, keywords, and marker-like text have no protocol authority and cannot create another child or confirmation.
